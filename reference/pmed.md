...
#>  .. - attr(*, "names")= chr "2.5%"
#>  @ ci_upper         : Named num 0.51
#>  .. - attr(*, "names")= chr "97.5%"
#>  @ ci_level         : num 0.95
#>  @ method           : chr "parametric_bootstrap"
#>  @ n_boot           : int 500
#>  @ boot_estimates   : num [1:500] 0.466 0.448 0.486 0.489 0.462 ...
#>  @ ie_estimate      : num 0.204
#>  @ ie_ci_lower      : Named num 0.122
#>  .. - attr(*, "names")= chr "2.5%"
#>  @ ie_ci_upper      : Named num 0.312
#>  .. - attr(*, "names")= chr "97.5%"
#>  @ ie_boot_estimates: num [1:500] 0.16 0.158 0.215 0.289 0.275 ...
#>  @ x_ref            : num 0
#>  @ x_value          : num 1
